function createLoan() {
    var loanName = document.getElementById("grantName1").value;
    ...
    var params = "grantName="+loanName+"&minDuration="+minDuration+ "&maxDuration="+maxDuration+ "minAmount="+minAmount+ "interestRate="+ interestRate;
    alert(params);
